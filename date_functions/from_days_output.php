...
<div class="container mt-4">
    <h4 class="mb-3"><b>Comic Date + 3 days (Using FROM_DAYS)</b></h4>
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                $sql = "SELECT comic_title, created_at, 
                               FROM_DAYS(TO_DAYS(created_at) + 3) AS plus_3_days
                        FROM comic";
