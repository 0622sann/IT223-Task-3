...
<div class="container mt-4">
    <h4 class="mb-3"><b>Stock Status (Using IF Function)</b></h4>
    ...
    <div class="table-responsive">
        <table class="table table-striped">
            ...
            <tbody>
                <?php
                include '../dbconn.php';
                $sql = "SELECT comic_title, comic_stock, IF(comic_stock <= 5, 'Stock is low', 'Stock is sufficient') AS stock_status FROM comic";
