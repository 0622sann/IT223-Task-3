...
<div class="container mt-4">
    <h4 class="mb-3"><b>Formatted Comic Date (Using DATE_FORMAT)</b></h4>
    <div class="table-responsive">
        <table class="table table-striped">
            ...
            <tbody>
                <?php
                include '../dbconn.php';
                $sql = "SELECT comic_title, created_at, DATE_FORMAT(created_at, '%W, %M %d, %Y %H:%i:%s') AS formatted_date FROM comic";
