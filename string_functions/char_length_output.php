...
<head>
    ...
    <title>CHAR_LENGTH Function Output</title>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/css/bootstrap.min.css">
</head>
<body>
<div class="container mt-4">
    <h4 class="mb-3"> <b>Length of Customer Names</b></h4>
    <div class="table-responsive">
        <table class="table table-striped">
            ...
            <tbody>
                <?php
                include '../dbconn.php';
                $sql = "SELECT customer_name, CHAR_LENGTH(customer_name) AS name_length FROM customers";
