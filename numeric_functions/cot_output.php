...
<div class="container mt-4">
    <h4 class="mb-3"><b>COT Function on Comic Stock</b></h4>
    <div class="table-responsive">
        <table class="table table-striped">
            ...
            <tbody>
                <?php
                include '../dbconn.php';
                $sql = "SELECT comic_title, comic_stock, COT(comic_stock) AS cot_value FROM comic";
                ...
                if(mysqli_num_rows($result) > 0){
                    while($row = mysqli_fetch_assoc($result)){
                        ...
                        echo "<td>".number_format($row['cot_value'], 4)."</td>";
                        echo "</tr>";
                    }
                } else {
